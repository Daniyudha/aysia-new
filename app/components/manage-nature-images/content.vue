...
import { useNatureImages } from "../../composables/useNatureImages";
...
const { images, addImages, deleteImage, refresh, loading } = useNatureImages();
...
async function handleSaveTitle(imageId: string) {
  ...
  try {
    await natureImagesFetcher().updateTitleById(imageId, { title });
            ...
            <div v-for="image in images" :key="image.id" class="border border-dashboard-neutral-100/50 rounded-lg overflow-hidden bg-white">
              ...
              <div class="relative group overflow-hidden">
                ...
                <div
                  ...
                  <button type="button"
                    class="text-white bg-red-600 hover:bg-red-700 rounded-full w-12 h-12 flex items-center justify-center transition transform scale-75 group-hover:scale-100"
