...
import { computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineAsyncComponent, defineComponent, Fragment, mergeProps, openBlock, ref, renderList, renderSlot, toDisplayString, unref, useSSRContext, withAsyncContext, withCtx } from "vue";
...
import { _ as __nuxt_component_0, c as __nuxt_component_0$1$1, a as __nuxt_component_1$1$1 } from "./card-BC35WKp2.mjs";
...
import { _ as __nuxt_component_2$2, a as __nuxt_component_3$2, c as __nuxt_component_4$2, b as __nuxt_component_5$2 } from "./head-CEZx0sjE.mjs";
...
import { a as __nuxt_component_16, b as useNuxtApp, e as useRoute, u as useRuntimeConfig } from "./server.mjs";
import { u as useModalForm } from "./useModalForm-CBkmuIPn.mjs";
import { _ as __nuxt_component_5$1, F as Field, t as toTypedSchema, u as useForm } from "./vee-validate-zod-NJbS403e.mjs";
                    ...
                    _push3(ssrRenderComponent(_component_UiFormItem, {
                      ...
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [
                            !unref(values)?.thumbnailUrl?.length
            ...
            return [
              createVNode("div", { class: "w-full mx-auto" }, [
                __props.isHeader === false
                  ...
                  : createCommentVNode("", true),
                unref(values)?.type === "image" || __props.isHeader === true
                  ? (openBlock(), createBlock(_component_Field, {
                      key: 1,
                      name: "thumbnail",
                    }, {
                        ...
                        _push4(ssrRenderComponent(_component_UiAccordionContent, { class: "text-muted-foreground" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              return [
                                unref(detailJourneyPending)
                                  ? (openBlock(), createBlock("p", { key: 0 }, "Loading..."))
                                  : !unref(detailJourneyPending) && !!unref(detailJourneyError) || !unref(detailJourneyData) && !unref(detailJourneyPending)
                                      ? (openBlock(), createBlock("p", { key: 1 }, "Data not data."))
                                      : (openBlock(), createBlock(_component_ManageGalleryDetailForm, {
                                          "key": 2,
                                          "default-value": unref(detailJourneyData),
                                          "mode": "update",
                                          "isHeader": true,
