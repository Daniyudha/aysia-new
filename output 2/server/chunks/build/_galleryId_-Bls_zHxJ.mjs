import { DialogClose, DialogContent, DialogDescription, DialogOverlay, DialogPortal, DialogRoot, DialogTitle, Primitive, useForwardPropsEmits } from "reka-ui";
import { tv } from "tailwind-variants";
import { computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, Fragment, mergeProps, openBlock, reactive, renderSlot, toDisplayString, Transition, unref, useSSRContext, withCtx } from "vue";
import { ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderAttr, ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderSlotInner, ssrRenderStyle } from "vue/server-renderer";
...
import { _ as _export_sfc, e as useRoute, u as useRuntimeConfig } from "./server.mjs";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                          ...
                          if (_push4) {
                            ...
                            return [
                              renderSlot(_ctx.$slots, "title", {}, () => [
                                __props.title
                                  ? (openBlock(), createBlock(_component_UiDialogTitle, {
                                      key: 0,
                                      title: __props.title,
                                    }, null, 8, ["title"]))
                              ...
                              renderSlot(_ctx.$slots, "description", {}, () => [
                                __props.description
                                  ? (openBlock(), createBlock(_component_UiDialogDescription, {
                                      key: 0,
                  ...
                  return [
                    ...
                    !__props.hideClose
                      ? (openBlock(), createBlock(_component_UiDialogClose, {
                          key: 0,
                        ...
                        !!_ctx.$props.isVideo && !!_ctx.$props.videoUrl
                          ? (openBlock(), createBlock("div", {
                              ...
                              isYouTubeUrl(_ctx.$props.videoUrl)
                                ...
                                : /\.(mp4|webm|ogg)$/i.test(_ctx.$props.videoUrl)
                                  ? (openBlock(), createBlock("video", {
                                    ...
                                    }, " Your browser does not support the video tag. ", 8, ["src"]))
                                  : createCommentVNode("", true),
                            ], 4))
                          : (openBlock(), createBlock(Fragment, { key: 1 }, [
                              _ctx.$props.image?.length
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function handleChangeImage(index) {
      if (index < 0 || index >= props.journeyDetailItems.length)
        return;
      showDialogState.selectedJourneyIndex = index;
    }
    const selectedJourney = computed(() => {
      if (showDialogState.selectedJourneyIndex === void 0 || showDialogState.selectedJourneyIndex < 0)
        return null;
    ...
    function getYouTubeId(url) {
      if (!url)
        return null;
      const patterns = [
        /(?:youtube\.com\/shorts\/|youtube\.com\/embed\/)([\w-]{11})/,
