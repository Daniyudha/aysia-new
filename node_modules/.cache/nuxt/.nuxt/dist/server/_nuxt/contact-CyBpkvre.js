...
import { _ as __nuxt_component_1$1, a as __nuxt_component_2, b as __nuxt_component_3$1 } from "./instagram3-BmIGgmU2.js";
import { _ as __nuxt_component_4 } from "./tiktok-CZO7HolP.js";
import { defineComponent, mergeProps, useSSRContext, unref, withCtx, createVNode, inject, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { u as useForm, t as toTypedSchema, F as Field, _ as __nuxt_component_6$1 } from "./vee-validate-zod-IdSZT6Cb.js";
import { _ as __nuxt_component_1 } from "./floating-item-BchvHrqG.js";
import { tv } from "tailwind-variants";
import { _ as __nuxt_component_0 } from "./button-CjXLYte9.js";
import { z } from "zod";
...
import "./index-DPeN2b2z.js";
import "./asyncData-BrPkS9sX.js";
...
const __nuxt_component_5$1 = Object.assign(_sfc_main$4, { __name: "IconWhatsapp" });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiInput = __nuxt_component_6$1;
...
const __nuxt_component_6 = Object.assign(_sfc_main$1, { __name: "ContactMessageForm" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconInstagram1 = __nuxt_component_1$1;
      const _component_IconInstagram2 = __nuxt_component_2;
      const _component_IconInstagram3 = __nuxt_component_3$1;
      const _component_IconTiktok = __nuxt_component_4;
      const _component_IconWhatsapp = __nuxt_component_5$1;
      const _component_ContactMessageForm = __nuxt_component_6;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-6" }, _attrs))}><div class="app-container"><div class="grid grid-cols-2 gap-8 justify-between items-center px-0"><div class="col-span-2 lg:col-span-1"><img${ssrRenderAttr("src", _imports_0)} alt="Aysia Contact" width="530" height="707" class="w-full h-auto object-cover object-top rounded-lg"></div><div class="col-span-2 lg:col-span-1 flex flex-col justify-center"><h1 class="mb-6 text-[3rem] font-medium leading-[100%] tracking-[0%] text-app-secondary">${ssrInterpolate(unref(t)("contact.heading"))}</h1><div class="font-sans text-sm space-y-6 font-light mb-6"><p>${ssrInterpolate(unref(t)("contact.paragraph1"))}</p><p>${ssrInterpolate(unref(t)("contact.paragraph2"))}</p></div><ul class="flex items-center space-x-6 space-y-4 md:space-y-0 flex-wrap mb-6">`);
      if (!!unref(sharedData)?.instagram1?.link?.length) {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(sharedData).instagram1.link,
          external: "",
          target: "_blank",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_IconInstagram1, { fill: "#533A1B" }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_IconInstagram1, { fill: "#533A1B" })
              ];
            }
          }),
          _: 1
      ...
      if (!!unref(sharedData)?.instagram2?.link?.length) {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(sharedData).instagram2.link,
          external: "",
          target: "_blank",
          class: "link-with-icon"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_IconInstagram2, { fill: "#533A1B" }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_IconInstagram2, { fill: "#533A1B" })
              ];
            }
          }),
          _: 1
      ...
      if (!!unref(sharedData)?.instagram3?.link?.length) {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(sharedData).instagram3.link,
          external: "",
          target: "_blank",
          class: "link-with-icon"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_IconInstagram3, { fill: "#533A1B" }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_IconInstagram3, { fill: "#533A1B" })
              ];
            }
          }),
          _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="inline-block text-2xl font-normal leading-[100%]"${_scopeId}>${ssrInterpolate(unref(t)("contact.whatsapp_text"))}</span>`);
          } else {
            return [
              createVNode(_component_IconWhatsapp, { fill: "#533A1B" }),
              createVNode("span", { class: "inline-block text-2xl font-normal leading-[100%]" }, toDisplayString(unref(t)("contact.whatsapp_text")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=contact-CyBpkvre.js.map
